...
def criar_pdf_premium(dados_entrada, resultados, imagem_grafico_path):
    ...
    # 1. Dados dos Ativos (Espelho da Simulação)
...
with c1:
    ...
    financeiro_venda = st.number_input("Valor de VENDA (Mercado) R$", 105000.0, help="Valor líquido de resgate hoje")
...
if btn_calcular:
    ...
    if has_cross:
        ...
        kpi3.metric("Recuperação", "Nunca", delta="Troca Desvantajosa", delta_color="inverse")

    # --- GRÁFICO (Configuração Visual) ---
    fig = go.Figure()
    
    color_v1 = "#95a5a6" # Cinza
    color_v2 = "#27ae60" # Verde
